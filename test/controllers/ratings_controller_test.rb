...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { idea_id: @rating.idea_id, rating: @rating.rating } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { idea_id: @rating.idea_id, rating: @rating.rating } }
